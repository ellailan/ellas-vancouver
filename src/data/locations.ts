...
export const locations: Location[] = [
  ...
  // ---------- Entertainment ----------
  {
    ...
    address: '3440 Cambie St, Vancouver, BC',
    latitude: 49.254597043328616,
    longitude: -123.11499599999999,
    description: 'Coziest movie theater in Vancouver',
  },
  {
    id: 'rio-theatre',
    name: 'Rio Theatre',
    ...
    latitude: 49.26234940845771,
    longitude: -123.07047336077108,
    description:
      'Fell in love with this place when I was 14 and really into the Rocky Horror Picture Show. Let\'s do the time warp again!',
  },
  {
    id: 'the-norm',
    name: 'The Norm',
    category: 'Entertainment',
    address: '6138 Student Union Blvd #130, Vancouver, BC V6T 1Z1',
    latitude: 49.26760099307809,
    longitude: -123.25015439145561,
    description: 'UBC Film Club always shows the weirdest most wonderful things here',
  },
  {
    id: 'the-vogue',
    name: 'The Vogue',
    ...
    latitude: 49.28007564793393,
    longitude: -123.12181893193437,
    description: 'If you\'re seeing a concert here you\'re in for a good night',
  },
  ...
  // ---------- Views ----------
  {
    ...
    latitude: 49.377384903330935,
    longitude: -123.0813774877505,
    description: 'Best views of the city are down the peak at 5:00PM in the winter',
  },
  {
    id: 'wreck-beach',
    name: 'Wreck Beach',
    ...
    latitude: 49.26292265556974,
    longitude: -123.26160417892706,
    description: 'Good place to stare off into the horizon after a bad midterm.',
  },
  {
    id: 'iona-north-arm-jetty',
    name: 'Iona North Arm Jetty',
    category: 'Views',
    address: 'Foreshore Trail, Richmond, BC V6T 1Z4',
    latitude: 49.21905473694331,
    longitude: -123.21474422762832,
    description: 'Underrated viewpoint.',
  },
  {
    id: 'sunset-beach-park',
    name: 'Sunset Beach Park',
    category: 'Views',
    address: '1204 Beach Ave, Vancouver, BC V6E 1V4',
    latitude: 49.27973601611001,
    longitude: -123.13814559946087,
    description: 'Walk here from Yaletown-Roundhouse in the summer to catch the sunset.',
  },
]
